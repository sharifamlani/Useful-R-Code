...
#For more infomration see https://sites.duke.edu/networksandhealth2017/helpful-links/siena-tutorial-using-r/

############# Read Data & Define Attributes ################
...
dim(s50all) # 3 50×50 adjacency matrices layered atop one another
...
myResults2 <- siena07(modelOptions, data=myDataDrinkSmoke,
                      ...
                      useCluster=TRUE, nbrNodes=3,
                       returnDeps=T) # specify starting values, return simulated nets (for GOF)
